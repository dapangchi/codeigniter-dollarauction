...
class CI_Email {
	...
	var	$smtp_host		= "smtp2.massmailing.pl";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "noreply-bookoflists@form.homax.pl";		// SMTP Username
	var	$smtp_pass		= "dy746jf827856hc";		// SMTP Password
