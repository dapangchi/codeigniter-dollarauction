...
onUploadChunk:function(){},onResume:function(){},onProgress:function(){},onError:function(){},onAutoRetry:function(){},onManualRetry:function(){},onValidateBatch:function(){},onValidate:function(){}},messages:{typeError:"Nieprawidłowy format pliku. Dopuszczalne formaty: {extensions}"/*"{file} has an invalid extension. Valid extension(s): {extensions}."*/,sizeError:"Plik {file} jest za duży, maksymalny rozmiar to {sizeLimit}.",minSizeError:"{file} is too small, minimum file size is {minSizeLimit}.",emptyError:"{file} is empty, please select files again without it.",noFilesError:"No files to upload.",
...
qq.FineUploader=function(a){qq.FineUploaderBasic.apply(this,arguments);qq.extend(this._options,{element:null,listElement:null,dragAndDrop:{extraDropzones:[],hideDropzones:!0,disableDefaultDropzone:!1},text:{uploadButton:"Wybierz plik",cancelButton:"Cancel",retryButton:"Retry",failUpload:"Upload failed",dragZone:"Przeciągnij plik aby wgrać",dropProcessing:"Processing dropped files...",formatProgress:"{percent}% of {total_size}",waitingForResponse:"Processing..."},template:'<div class="qq-uploader">'+
