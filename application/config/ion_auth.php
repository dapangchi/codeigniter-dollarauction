...
/*
 | -------------------------------------------------------------------------
 | Login and Register pages options.
 | -------------------------------------------------------------------------
 | Here we can turn on(TRUE) or off(FALSE) login and register pages.
*/
$config['register_active']					  = TRUE;						// TRUE to turn on register page, FALSE to turn off
$config['login_active']								= TRUE;							// TRUE to turn on login page, FALSE to turn off
