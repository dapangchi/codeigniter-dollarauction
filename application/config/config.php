...
|
*/
$config['encryption_key'] = '0hrnl1lVaml74hOro6Csx2wvb7ZmAWWC';
...
define('DB_NAME', 'admin_dollar');
define('DB_USER', 'admin_dollar');
define('DB_PASSWORD', 'Gnt66&p5');
...
define('admin_password', 'b9DeHNXPxC');
define('admin_username', 'raffledollardeluxe');
  
  //If you rename the a12.php login file, make sure you make the appropriate change below
 define('adminlogin', '/panel');
  ...
  define('password_request_limit', '10');
	set_include_path('/var/www/vhosts/isodevelopers.com/dollarbid.isodevelopers.com');
