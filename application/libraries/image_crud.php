...
class image_CRUD {
	...
	protected $description1_field = null;
	protected $description2_field = null;
	protected $description3_field = null;
	protected $description4_field = null;
	...
	function set_description1_field($description1_field)
	{
		$this->description1_field = $description1_field;

		return $this;
	}
	
	function set_description2_field($description2_field)
	{
		$this->description2_field = $description2_field;

		return $this;
	}
	
	function set_description3_field($description3_field)
	{
		$this->description3_field = $description3_field;

		return $this;
	}
	
	function set_description4_field($description4_field)
	{
		$this->description4_field = $description4_field;
    ...
    protected function _insert_title($primary_key, $value)
    {
		...
		echo "$this->ci->db->update($this->table_name, array($this->title_field => $value), array($this->primary_key => $primary_key));";
    }

	public function _insert_description1($primary_key, $value)
    {
		$this->ci->db->update($this->table_name, array($this->description1_field => $value), array($this->primary_key => $primary_key));
		echo "$this->ci->db->update($this->table_name, array($this->description1_field => $value), array($this->primary_key => $primary_key));";
    }
		
	public function _insert_description2($primary_key, $value)
	{
		$this->ci->db->update($this->table_name, array($this->description2_field => $value), array($this->primary_key => $primary_key));
		echo "$this->ci->db->update($this->table_name, array($this->description2_field => $value), array($this->primary_key => $primary_key));";
	}

	public function _insert_description3($primary_key, $value)
	{
		$this->ci->db->update($this->table_name, array($this->description3_field => $value), array($this->primary_key => $primary_key));
		echo "$this->ci->db->update($this->table_name, array($this->description3_field => $value), array($this->primary_key => $primary_key));";
	}
	
	public function _insert_description4($primary_key, $value)
	{
		$this->ci->db->update($this->table_name, array($this->description4_field => $value), array($this->primary_key => $primary_key));
		echo "$this->ci->db->update($this->table_name, array($this->description4_field => $value), array($this->primary_key => $primary_key));";
	}
	...
	protected function getState()
	{
		...
		if(isset($rsegments_array[3]) && is_numeric($rsegments_array[3]))
		{
			...
			$insert_description1_url  = site_url($rsegments_array[1].'/'.$rsegments_array[2].'/insert_description1');
			$insert_description2_url  = site_url($rsegments_array[1].'/'.$rsegments_array[2].'/insert_description2');
			$insert_description3_url  = site_url($rsegments_array[1].'/'.$rsegments_array[2].'/insert_description3');
			$insert_description4_url  = site_url($rsegments_array[1].'/'.$rsegments_array[2].'/insert_description4');
			...
			$state['insert_description1_url'] = $insert_description1_url;
			$state['insert_description2_url'] = $insert_description2_url;
			$state['insert_description3_url'] = $insert_description3_url;
			$state['insert_description4_url'] = $insert_description4_url;
		...
		elseif(isset($rsegments_array[3]) && $rsegments_array[3] == 'insert_description1')
		{
			$state = array( 'name' => 'insert_description1');
			return (object)$state;
		}
		elseif(isset($rsegments_array[3]) && $rsegments_array[3] == 'insert_description2')
		{
			$state = array( 'name' => 'insert_description2');
			return (object)$state;
		}
		elseif(isset($rsegments_array[3]) && $rsegments_array[3] == 'insert_description3')
		{
			$state = array( 'name' => 'insert_description3');
			return (object)$state;
		}
		elseif(isset($rsegments_array[3]) && $rsegments_array[3] == 'insert_description4')
		{
			$state = array( 'name' => 'insert_description4');
			return (object)$state;
		}
	}
			...
			switch ($state_info->name) {
				case 'list':
					...
					$this->_library_view('list.php',array(
						...
						'insert_description1_url' => $state_info->insert_description1_url,
						'insert_description2_url' => $state_info->insert_description2_url,
						'insert_description3_url' => $state_info->insert_description3_url,
						'insert_description4_url' => $state_info->insert_description4_url,
						'photos' => $photos,
						'ajax_list_url' => $state_info->ajax_list_url,
						'ordering_url' => $state_info->ordering_url,
						'primary_key' => $this->primary_key,
						'title_field' => $this->title_field,
						'description1_field' => $this->description1_field,
						'description2_field' => $this->description2_field,
						'description3_field' => $this->description3_field,
						'description4_field' => $this->description4_field,
				...
				case 'insert_description1':
					@ob_end_clean();
					$this->_insert_description1($_POST['primary_key'],$_POST['value']);
					die();
				break;
				
				case 'insert_description2':
					@ob_end_clean();
					$this->_insert_description2($_POST['primary_key'],$_POST['value']);
					die();
					break;
					
				case 'insert_description3':
					@ob_end_clean();
					$this->_insert_description3($_POST['primary_key'],$_POST['value']);
					die();
					break;
					
				case 'insert_description4':
					@ob_end_clean();
					$this->_insert_description4($_POST['primary_key'],$_POST['value']);
					die();
					break;
			}
		}
