            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center text-middle">
                        <a class="btn btn-info btn-sm" title="Edit" href="<?php echo admin_url("testimonial/edit/$r->tstm_id"); ?>"><i class="glyphicon glyphicon-edit"></i></a>
                        <a class="btn btn-danger btn-sm" title="Remove" href="<?php echo admin_url("testimonial/delete/$r->tstm_id"); ?>"><i class="glyphicon glyphicon-remove"></i></a>
                    </td>
                </tr> 
                <?php } ?>
            </tbody>
