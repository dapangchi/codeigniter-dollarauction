    ...
    <div class="col-lg-12">
        ...
        <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal', 'id' => 'aform', 'autocomplete' => 'off')); ?>
            ...
            <div class="form-group <?php echo form_error('sort') ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="sort" name="sort" placeholder="Sort" value="<?php echo set_value('sort', $row->sort); ?>" required>
                    <span class="help-inline"><?php echo form_error('sort');?></span>
                </div>
            </div>
