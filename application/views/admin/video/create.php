    ...
    <div class="col-lg-12">
        <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal', 'id' => 'aform', 'autocomplete' => 'off')); ?>
            <div class="form-group <?php echo form_error('vdo-title') ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="vdo-title" name="vdo-title" placeholder="Title" value="<?php echo set_value('vdo-title'); ?>">
            ...
            <div class="form-group <?php echo form_error('vdo-link') ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="vdo-link" name="vdo-link" placeholder="Link" value="<?php echo set_value('vdo-link'); ?>">
            ...
            <div class="form-group <?php echo isset($vdo_image_message) ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <div class="vdo-img-box" style="margin-bottom:5px;">
                        <img src="<?php echo thumbnail('', 300, 300); ?>" id="vdo-image-img"/>
                    </div>
