    ...
    <div class="col-lg-12">
        ...
        <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal', 'id' => 'aform', 'autocomplete' => 'off')); ?>
            <div class="form-group <?php echo form_error('link-name') ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="link-name" name="link-name" placeholder="Name" value="<?php echo set_value('link-name', $row->name); ?>" required>
            ...
            <div class="form-group <?php echo form_error('link-url') ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="link-url" name="link-url" placeholder="Link" value="<?php echo set_value('link-url', $row->link); ?>" required>
            ...
            <div class="form-group <?php echo form_error('link-sort') ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="link-sort" name="link-sort" placeholder="Sort" value="<?php echo set_value('link-sort', $row->sort); ?>" required>
