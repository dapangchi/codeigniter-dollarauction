    ...
    <div class="col-lg-12">
        ...
        <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal', 'id' => 'aform', 'autocomplete' => 'off')); ?>
            ...
            <div class="form-group <?php echo form_error('price') ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="price" name="price" placeholder="Price" value="<?php echo set_value('price', $row->price); ?>" required>
            ...
            <div class="form-group <?php echo isset($image_message) ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <div class="img-box" style="margin-bottom:5px;">
                        <img src="<?php echo thumbnail($row->image, 112, 112); ?>" id="image-img"/>
                    </div>
            ...
            <div class="form-group <?php echo form_error('content') ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control" id="content" name="content" placeholder="Content" rows="5" required><?php echo set_value('content', $row->content); ?></textarea>
